...
<body>
    ...
    <form>
      <section class="Selecionar">
        ...
        <div class="ODDD">
          ...
          <label class="dataID" for="data">Data de volta:</label></div>
  ...
  <div class="passagens-splide">
    <h2 class="chamadopsg" id="passagem">Passagens de voos internacionais para lugares incríveis
      <img style="width: 350px; display:block; height: 300px;" src="https://media.discordapp.net/attachments/965720659302969424/978149246387769364/flying-airplane.gif" alt="">
          ...
          <li class="splide__slide">
            <div class="box">
              ...
              <div class="detail-box">
                <!--type-------->
                <div class="type">
                  <a href="#">frança - paris </a>
                  <span>valor economica:</span>
                </div>
                <!--price-------->
  ...
  <!--HOTEIS-------->
  <h2 class="text-hotel">Encontre a hospedagem perfeita com os melhores preços</h2>
  <div class="card-hotel">
    ...
    <div class="caaaard">
      ...
      <div class="caaaard-info">
        ...
        <p class="texttt-body"> Estadia de uma semana no Olympic Hotel
    ...
    <div class="caaaard">
      ...
      <div class="caaaard-info">
        ...
        <p class="texttt-body">Estadia de 4 dias em Row NYC at Times Square

        </p>
      </div>
      <div class="caaaard-footer">
        <span class="texttt-title">Por 2.920
    ...
    <div class="caaaard">
      <div class="caaaard-img">
        <img src="https://static.budgetplaces.com/establishment/28/01/10128/2.jpg" alt="img hotel ">


      </div>
      <div class="caaaard-info">
        <p class="texttt-title">França
          Paris </p>
        <p class="texttt-body"> Estadia de uma semana no Au Pacific Hotel</p>
      </div>
      <div class="caaaard-footer">
        <span class="texttt-title">Por 3.500
    ...
    <div class="caaaard">
      ...
      <div class="caaaard-info">
        ...
        <p class="texttt-body">Estadia de uma semana no hotel Shinagawa Prince Hotel</p>
      </div>
      <div class="caaaard-footer">
  ...
  <!--CARDS-------->
  <h2 class="slogan-cards" id="cdLegal">Veja só o que preparamos para os clientes da Outside Trip</h2>
      ...
      <div class="containercard" id="cardi">
        <div class="cardi">
          <div class="contentcard">
            ...
            <p>É o cliente que possui o nosso programa “Outside trip Milhas”, ou seja, o cartão fidelidade para resgatar
              pontos acumulados de antigas viagens e reverter em descontos para viagens internacionais. Também ganha
              desconto em passagem no mês de aniversário, possui assentos em poltronas reclináveis, fila para embarque
              com prioridade e além disso, com direito a todos os outros diversos serviços!
              Obs: Está incluso o ganho exclusivo de: Chip de celular para uso no exterior.</p>
            <button class="bt-maisif"><a href="./MaisInformacoes.jsp">mais infomaçoes</a></button>
          </div>
    </section>
    <section>
      <div class="containercard">
        <div class="cardi">
          <div class="contentcard">
            ...
            <p>O hábito de jogar videogame é adotado por 38% da população brasileira, assim, nossa empresa oferece um
              “Nintendo Switch” para o nosso cliente se divertir durante a viagem com diversos jogos exclusivos e além
              de, 1 mês de Spotify para você curtir escutando músicas, podcasts e muito mais. Obs: Está incluso o ganho
              de: uma Necessaire, Cobertor Manta e Fone de Ouvido.</p>
            <button class="bt-maisif"><a href="./MaisInformacoes.jsp">mais infomaçoes</a></button>
          </div>
    </section>
    <section>
      <div class="containercard">
        <div class="cardi">
          <div class="contentcard">
            <h2>03</h2>
            <h3>Cliente VIP:</h3>
            <p> Nosso Cliente Vip ganha desconto em passagem no mês do seu aniversário. Como também, Carregador
              Portátil, Almofada de Pescoço, Fone de Ouvido, 3 meses de Spotify ou 6 meses de PSN Plus.</p>
            <button class="bt-maisif"><a href="./MaisInformacoes.jsp">mais infomaçoes</a></button>
          </div>
    </section>
      ...
      <div class="containercard">
        <div class="cardi">
          <div class="contentcard">
            <h2>04</h2>
            <h3>Cliente:</h3>
            <p> Todo mundo adora dar um cochilo durante o voo e por isso nossa empresa pensou em presentear nossos
              clientes com a Almofada de Pescoço, o uso desse item tem como principal objetivo impedir que a cabeça
              “caia” ao pegar no sono durante a viagem, dessa forma, mantendo-a em uma posição mais confortável. Como
              também ganha Fone de Ouvido, Cobertor Manta e Necessaire.
            </p>
            <button class="bt-maisif"><a href="./MaisInformacoes.jsp">mais infomaçoes</a></button>
          </div>
    </section>
