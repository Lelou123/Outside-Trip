...
<head>
    ...
    <link rel="icon" href="./imgs/logo carrinho-PhotoRoom.png">
        ...
        <form action="#">
            ...
            <div class="input-group">
                ...
                <div class="input-box">
                    ...
                    <input id="confirmPassword" type="password" name="confirmPassword" maxlength="3"
            ...
            <div class="continue-button">
                <button><a href="./index.html">Finalizar compra</a> </button>
            </div>
        </form>
    </div>
    </div>
